...
public class CouponService {
	...
	public CouponVO addCoupon(
			...
			Double discount,Integer discount_limit) {
	...
	public CouponVO updateCoupon(String coupon_name, Integer discount_duration, Integer trigger_threshold, Double discount,Integer discount_limit, Integer coupon_id) {
